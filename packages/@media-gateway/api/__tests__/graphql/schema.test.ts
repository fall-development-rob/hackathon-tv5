...
describe("GraphQL Schema", () => {
  describe("Schema Construction", () => {
    ...
    it("should include type definitions", () => {
      ...
      // gql returns a DocumentNode object, not a string
  ...
  describe("Validation Utilities", () => {
    describe("validateRating", () => {
      ...
      it("should reject ratings below 0", () => {
        expect(() => validation.validateRating(-1)).toThrow(
          "Rating must be between 0 and 10",
        );
      });

      it("should reject ratings above 10", () => {
        expect(() => validation.validateRating(11)).toThrow(
          "Rating must be between 0 and 10",
        );
      });
    });
    ...
    describe("validateVoteScore", () => {
      ...
      it("should reject scores below 1", () => {
        expect(() => validation.validateVoteScore(0)).toThrow(
          "Vote score must be between 1 and 10",
        );
      });

      it("should reject scores above 10", () => {
        expect(() => validation.validateVoteScore(11)).toThrow(
          "Vote score must be between 1 and 10",
        );
      });
    });
    ...
    describe("validateLimit", () => {
      ...
      it("should enforce minimum limit of 1", () => {
        // 0 is falsy so returns default (20), negative values clamp to 1
        expect(validation.validateLimit(0)).toBe(20);
    ...
    describe("validateYearRange", () => {
      ...
      it("should reject future years beyond threshold", () => {
        ...
        expect(() =>
          validation.validateYearRange(undefined, currentYear + 10),
        ).toThrow();
      });
      ...
      it("should allow undefined values", () => {
        ...
        expect(() =>
          validation.validateYearRange(undefined, 2024),
        ).not.toThrow();
      });
    });
  });
