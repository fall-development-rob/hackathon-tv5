...
export const SearchQuerySchema = z.object({
  ...
  mediaType: z.enum(['movie', 'series', 'documentary', 'sports', 'all']).optional(),
...
export const RecommendationsQuerySchema = z.object({
  ...
  mood: z.enum(['relaxed', 'excited', 'thoughtful', 'social', 'adventurous']).optional(),
...
export const AvailabilityQuerySchema = z.object({
  region: z.string().length(2, 'Region must be a 2-letter country code').default('US'),
});
