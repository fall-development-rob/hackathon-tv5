...
describe("Platform Entity", () => {
  ...
  describe("getDeepLink", () => {
    it("should generate deep link with content ID", () => {
      const platform = createTestPlatform();
      expect(platform.getDeepLink("12345")).toBe(
...
describe("Availability Value Object", () => {
  const createAvailability = (
    type: "subscription" | "rent" | "buy" | "free" = "subscription",
  ) =>
    new Availability(
      "netflix",
      "Netflix",
...
describe("PlatformSubscription Value Object", () => {
  const createSubscription = (
    status: "active" | "expired" | "canceled" | "trial" = "active",
  ) => {
    const start = new Date("2024-01-01");
    // Use a future date to ensure isExpired() returns false for active subscriptions
  ...
  describe("status checks", () => {
    ...
    it("should identify expired subscriptions", () => {
      ...
      const sub = new PlatformSubscription(
        "netflix",
        "Netflix",
        "expired",
        new Date(),
...
describe("PlatformStatistics Value Object", () => {
  const createStats = () =>
    new PlatformStatistics("netflix", 1000, 600, 400, 7.5, new Date());
  ...
  it("should detect stale statistics", () => {
    ...
    const stats = new PlatformStatistics(
      "netflix",
      1000,
      600,
      400,
  ...
  it("should detect good quality content", () => {
    const goodStats = new PlatformStatistics(
      "quality",
      100,
      50,
      50,
    ...
    const poorStats = new PlatformStatistics(
      "poor",
      100,
      50,
      50,
